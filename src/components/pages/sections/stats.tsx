...
import type { GitHubStatsResponse, Week } from "@/types/github";
...
/**
 * Local replacement for react-github-calendar, which fetched the grid from a
 * third-party API. Renders whatever weeks the config hands it — no network.
 */
...
export default function Stats() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 0:
        return <OverviewContent data={githubData} />;
      case 1:
        return <ActivityContent data={githubData} />;
      case 2:
        return <InsightsContent data={githubData} />;
      default:
        return null;
    }
  };
