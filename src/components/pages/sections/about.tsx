              ...
              {aboutParagraphs.map((paragraph, i) => (
                <p key={i}>
                  ...
                  <span className="mx-1 inline-block align-middle">
                    <span
                      className={cn(
                        "ring-offset-background relative inline-block w-12 overflow-hidden rounded-md ring ring-offset-2",
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          {
                            "bg-red-500": !profile.availableForWork,
                          },
                        )}
                      />
                      {!profile.availableForWork ? "Not Available" : "Available"}
                    </Badge>
